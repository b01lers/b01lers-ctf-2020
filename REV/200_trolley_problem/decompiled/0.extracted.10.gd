...
", 0.2)
		tie.buff_silence(1)
		tie.buff_text("But now I'll ", 0.1)
		tie.buff_text("DROP", 0.02)
		tie.buff_silence(0.4)
		tie.buff_text(" THE BASS
", 0.02)
		tie.buff_silence(0.4)
		tie.buff_text("TVUVTUVUTUVU WOODBODBOWBDODBO TUUVUTVU WODWVDOOWDV WODOWVOOWDVOWVD DUBDUBDUBUDUDB OWVDOWVWDOWVDOWVDOWVDWVDOWVDOWVODV", 0.04)
	elif (i == 2):
